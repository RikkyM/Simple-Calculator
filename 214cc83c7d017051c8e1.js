...
.bg-\\[\\#151C22\\] {
  --tw-bg-opacity: 1;
  background-color: rgba(21, 28, 34, 1);
  background-color: rgba(21, 28, 34, var(--tw-bg-opacity));
}
.bg-\\[\\#262C48\\] {
  --tw-bg-opacity: 1;
  background-color: rgba(38, 44, 72, 1);
  background-color: rgba(38, 44, 72, var(--tw-bg-opacity));
}
.bg-\\[\\#4F6088\\] {
  --tw-bg-opacity: 1;
  background-color: rgba(79, 96, 136, 1);
  background-color: rgba(79, 96, 136, var(--tw-bg-opacity));
}
.bg-\\[\\#C01515\\] {
  --tw-bg-opacity: 1;
  background-color: rgba(192, 21, 21, 1);
  background-color: rgba(192, 21, 21, var(--tw-bg-opacity));
}
.bg-transparent {
...
.text-\\[\\#25F79E\\] {
  --tw-text-opacity: 1;
  color: rgba(37, 247, 158, 1);
  color: rgba(37, 247, 158, var(--tw-text-opacity));
}
.text-\\[\\#FEEA5F\\] {
  --tw-text-opacity: 1;
  color: rgba(254, 234, 95, 1);
  color: rgba(254, 234, 95, var(--tw-text-opacity));
}
.text-white {
  --tw-text-opacity: 1;
...
/* harmony import */ var _js_hitung_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/hitung.js */ "./src/js/hitung.js");
/* harmony import */ var _js_hitung_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_hitung_js__WEBPACK_IMPORTED_MODULE_1__);
